...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.fitnesstracker.fitnessworld.services.UserService.getUsers(..))")
    public void getUsersMethod() {
    }

    @Before("getUsersMethod()")
    public void logBefore() {
        logger.info("Fetching all users...");
    }

    @AfterReturning(pointcut = "getUsersMethod()", returning = "result")
